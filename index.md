   ...
   <tr>
      ...
      <td rowspan="3" style="border-bottom: 2px solid #9146FF">
         ...
         <font color="#e59ab3">
            ...
            <p style="border:2px; border-style:dashed; border-color:#e59ab3; padding: 1em; border-radius: 8px; width: 175px">-ul={[broad]caster/owner}[only]<br>-ul={moderator[s]/mod[s]}[only]<br>-ul={subscriber[s]/sub[s]}[only]</p>
