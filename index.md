...
<thead>
   <tr>
      ...
      <th>Parameters</th>
      <th>Notes</th>
      <th style="border-right: 2px solid #323232" width="20%">Example</th>
<tfoot>
   <tr>
...
<tbody>
   ...
   <tr>
      <td><font color="#f2a2e8">Subscriber</font>/<br><font color="#baed91">Moderator</font></td>
      <td>!urban</td>
   ...
   <tr>
      ...
      <td rowspan="3">
         ...
         <font color="#f8b88b">
            ...
            <p style="border:2px; border-style:dashed; border-color:#f8b88b; padding: 1em; border-radius: 8px; width: 175px">-ul={[broad]caster/owner}[only]<br>-ul={moderator[s]/mod[s]}[only]<br>-ul={subscriber[s]/sub[s]}[only]</p>
      ...
      <td rowspan="3">
         ...
         <hr>
         !command add !test -ul=mod This is a test command.
         <hr>
