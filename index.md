...
<tbody>
   ...
   <tr>
      <td style="border-bottom: 15px ridge #2E2E2E">Everyone</td>
      <td style="border-bottom: 15px ridge #2E2E2E">!contact</td>
      <td style="border-bottom: 15px ridge #2E2E2E">!business, !email, !inquiry</td>
      <td style="border-bottom: 15px ridge #232323"></td>
      <td style="border-bottom: 15px ridge #232323">Returns the streamer's business email.</td>
      <td style="border-bottom: 15px ridge #232323">!contact</td>
   </tr>
   <tr>
      <td>Everyone</td>
      <td>!hype</td>
   ...
   <tr>
      ...
      <td>!language</td>
      <td></td>
      <td>Returns "Please speak English in chat" in six popular languanges on Twitch.<br><br><em><font color="#f595b5">Use the shortened version of the commands (!eng and !lang) to have the bot return the simplified version of the output indicated in the row above.</font></em></td>
      <td>!english</td>
   </tr>
   <tr>
      <td>Everyone</td>
   ...
   <tr>
      <td rowspan="3" style="border-bottom: 2px solid #9146FF"><font color="#19b51c">Moderator</font></td>
   ...
   <tr>
      <td style="border-bottom: 2px solid #9146FF"><font color="#19b51c">Moderator</font></td>
   ...
   <tr>
      ...
      <td style="border-bottom: 2px solid #9146FF">Converts the given number to U.S. gallons.<br><br><em><font color="#f595b5">The single-letter alias is case-sensitive.</font></em></td>
   ...
   <tr>
      ...
      <td rowspan="3" style="border-bottom: 2px solid #9146FF">
         ...
         <font color="#f595b5">
            ...
            <p style="border:2px; border-style:dashed; border-color:#f595b5; padding: 1em; border-radius: 8px; width: 175px">-ul={[broad]caster/owner}[only]<br>-ul={moderator[s]/mod[s]}[only]<br>-ul={subscriber[s]/sub[s]}[only]</p>
